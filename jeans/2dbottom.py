...
frame = cv2.imread('original.jpeg')
...
#cv2.imshow('final_out',final_mask_black_3CH)
#img = cv2.imread("C:/Users/5001tu/Downloads/Hackathon Module No#idk/")
cv2.imwrite("output.png",final_mask_black_3CH)
